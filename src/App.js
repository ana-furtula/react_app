...
function App() {
  ...
  const [products, setProducts] = useState([
    ...
    },
    {
      id: 4,
      title: "iPhone",
      gallery: "https://macola.rs/wp-content/uploads/2021/09/iphone-12-pro-blue-hero-423x500.png",
      description:
        "Chocolate is a food made from cacao beans. It is used in many desserts like pudding, cakes and candy",
      price: 550,
      category : "phone"
    },
    {
      id: 5,
      title: "Smart watch",
      gallery: "https://www.mytrendyphone.rs/images/Waterproof-Smartwatch-with-Heart-Rate-K12-IP68-Bluetooth-4-Black-10092020-01A-p.jpg",
      description:
        "Lollipops are available in a number of colors and flavors, particularly fruit flavors.",
      price: 300,
      category : "tv"
    },
    {
      id: 6,
      title: "Lenovo laptop",
      gallery: "https://www.tehnomanija.rs/UserFiles/products/2019/008/large/138734.webp",
      description:
        "Ice cream is a sweetened frozen food typically eaten as a snack or dessert.",
      price: 700,
      category : "laptop"
  ...
  return (
    <BrowserRouter className="App">
      ...
      <Routes>
        ...
        <Route
          path = "/details/:id"
          element = {<Details products = {products}></Details>}
        />
      </Routes>
    </BrowserRouter>
  );
